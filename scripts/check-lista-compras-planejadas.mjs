...
assert.match(form, /:dense="false"/);
assert.match(form, /links-section--dark/);
assert.match(form, /Adicione o nome da loja e o link do produto/);
assert.match(form, /background: rgba\(255, 255, 255, 0\.06\)/);
assert.match(form, /border-color: rgba\(255, 255, 255, 0\.22\)/);
assert.match(form, /color: #b7b9c4/);
assert.match(form, /props\.compra \? 'Salvar alterações' : 'Salvar'/);
assert.doesNotMatch(form, /Salvar plano/);
